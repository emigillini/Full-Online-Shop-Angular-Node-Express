...
exports.addProductValidators = [
    ...
    (0, express_validator_1.body)('price').isNumeric().withMessage('Price must be a number').custom(value => value > 0).withMessage('Price must be positive'),
    (0, express_validator_1.body)('stock').isNumeric().withMessage('Stock must be a number').custom(value => value >= 0).withMessage('Stock must be non-negative'),
...
exports.modifyProductValidators = [
    ...
    (0, express_validator_1.body)('price').optional().isNumeric().withMessage('Price must be a number').custom(value => value > 0).withMessage('Price must be positive'),
    (0, express_validator_1.body)('stock').optional().isNumeric().withMessage('Stock must be a number').custom(value => value >= 0).withMessage('Stock must be non-negative'),

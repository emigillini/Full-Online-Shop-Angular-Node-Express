...
export const addProductValidators = [
  ...
  body('price').isNumeric().withMessage('Price must be a number').custom(value => value > 0).withMessage('Price must be positive'),
  body('stock').isNumeric().withMessage('Stock must be a number').custom(value => value >= 0).withMessage('Stock must be non-negative'),
...
export const modifyProductValidators = [
  ...
  body('stock').optional().isNumeric().withMessage('Stock must be a number').custom(value => value >= 0).withMessage('Stock must be non-negative'),

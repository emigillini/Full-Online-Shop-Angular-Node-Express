...
export class ConversationController {
    ...
    async createConversation(req: Request, res: Response): Promise<void> {
        try {
            ...
            const conversation = await conversationService.createConversation(user._id, name); 
    ...
    async closeConversation(req: Request, res: Response): Promise<void> {
        try {
            ...
            const updatedConversation = await conversationService.closeConversation(conversationId);
